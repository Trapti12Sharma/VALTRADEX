...
const Navbar = () => {
  ...
  const tradingAccountSubItems = [
    {
      icon: <FaExchangeAlt className="text-[#0040FF]" />,
      title: "Standard STP",
      link: "/standard-stp",
    },
    {
      icon: <FaPercent className="text-[#0040FF]" />,
      title: "RAW ECN",
      link: "/raw-ecn",
    },
    {
      icon: <FaChartBar className="text-[#0040FF]" />,
      title: "PRO ECN",
      link: "/pro-ecn",
    },
    // {
    //   icon: <FaUndo className="text-[#0040FF]" />,
    //   title: "Swap Free",
    //   link: "/swap-free",
    // },
    {
      icon: <FaMoneyBillAlt className="text-[#0040FF]" />,
      title: "Cent Account",
      link: "/cent-account",
    },
    {
      icon: <FaUserCircle className="text-[#0040FF]" />,
      title: "Demo Account",
      link: "/demo-account",
    },
  ];
  ...
  const tradingDropdownItems = [
    {
      icon: <FaUserAlt className="text-[#0040FF]" />,
    ...
    {
      icon: <FaCopy className="text-[#0040FF]" />,
      title: "Copy Trading",
  ...
  const toolsDropdownItems = [
    {
      icon: <FaCheckCircle className="text-[#0040FF]" />,
      title: "Overview",
      description: "Tools suite",
      link: "/tools-overview",
    },
    {
      icon: <FaBullhorn className="text-[#0040FF]" />,
      title: "Market Buzz",
      description: "AI insights",
      link: "/market-buzz",
    },
    {
      icon: <FaCalendarAlt className="text-[#0040FF]" />,
      title: "Economic Calendar",
      description: "Events",
      link: "/economic-calendar",
    },
    {
      icon: <FaRobot className="text-[#0040FF]" />,
  ...
  const marketsDropdownItems = [
    {
      icon: <FaChartPie className="text-[#0040FF]" />,
      title: "Markets",
      link: "/markets",
    },
    {
      icon: <FaChartLine className="text-[#0040FF]" />,
      title: "Forex",
      link: "/forex",
    },
    {
      icon: <FaIndustry className="text-[#0040FF]" />,
      title: "Indices",
      link: "/indices",
    },
    {
      icon: <FaGem className="text-[#0040FF]" />,
      title: "Precious Metals",
      link: "/precious-metals",
    },
    {
      icon: <FaLeaf className="text-[#0040FF]" />,
      title: "Soft Commodities",
      link: "/soft-commodities",
    },
    {
      icon: <FaLayerGroup className="text-[#0040FF]" />,
      title: "ETFs",
      link: "/etfs",
    },
    {
      icon: <FaShareAlt className="text-[#0040FF]" />,
      title: "CFD Shares",
      link: "/cfd-shares",
    },
    {
      icon: <FaUniversity className="text-[#0040FF]" />,
      title: "CFD Bonds",
      link: "/cfd-bonds",
    },
  ];
  ...
  const platformsDropdownItems = [
    {
      icon: <FaCogs className="text-[#0040FF]" />,
      title: "Platforms",
      link: "/platforms",
    },
    {
      icon: <FaMobileAlt className="text-[#0040FF]" />,
      title: "Valtradex App",
      link: "/valtradex-app",
    },
    {
      icon: <FaDesktop className="text-[#0040FF]" />,
      title: "MetaTrader 5",
      link: "/metatrader-5",
    },
    {
      icon: <FaLaptop className="text-[#0040FF]" />,
      title: "MetaTrader 4",
      link: "/metatrader-4",
    },
    {
      icon: <FaTradingView className="text-[#0040FF]" />,
      title: "TradingView",
      link: "/tradingview",
    },
    {
      icon: <FaGlobeEurope className="text-[#0040FF]" />,
      title: "WebTrader",
      link: "/webtrader",
    },
  ];
  ...
  const companyDropdownItems = [
    {
      icon: <FaInfoCircle className="text-[#0040FF]" />,
      title: "About Us",
      description: "Who we are",
      link: "/about-us",
    },
    {
      icon: <FaHeadset className="text-[#0040FF]" />,
      title: "Help Centre",
      description: "Support",
      link: "/help-centre",
    },
    {
      icon: <FaBalanceScale className="text-[#0040FF]" />,
      title: "Legal Hub",
      description: "Legal",
      link: "/legal-hub",
    },
  ...
  return (
    ...
    >
      <div className="w-full flex items-center justify-between px-4 sm:px-6 md:px-10 py-4">
        {/* ✅ Logo on the absolute left corner */}
  ...
  `}
        ...
        {/* Desktop Navigation */}
        <nav className="hidden lg:flex items-center space-x-8 text-sm font-medium text-white relative ml-auto">
          {navItems.map((item) => (
            <div
              key={item.name}
              className="relative"
      ...
      {/* ✅ Mobile Menu */}
      {isMobileMenuOpen && (
        <div className="lg:hidden absolute left-0 right-0 top-full bg-[#030B17] text-white z-40 overflow-y-auto h-[100vh] transition-all duration-300">
